...
async function load(){
    var largest = await invoke("view_and_sort", {targetDirectory: "/Users/adhamelkhouly/Desktop"});
    console.log("weewoo");
    console.log(largest);
   // var ul = document.createElement("ul");
    // ul.className = "list-view";
    // cont.appendChild(ul);
    // for (var child of largest){
    //     var childEl = document.createElement("li");
    //     console.log(child);
    //     childEl.textContent= child.name + "\t SIZE: " + child.size.toString() + "B";
    //     ul.appendChild(childEl);
    // }
    var text = document.getElementById('text');
    var table= '<table align="center"><thead><tr><th>Index</th><th>File</th><th>Size></thead><tbody>';
    var i = 1;
    for (var child of largest){
